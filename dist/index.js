...
(() => {
  ...
  window.Webflow.push(() => {
    ...
    if (isHome) {
      ...
      let heroTimeline = gsapWithCSS.timeline();
      heroTimeline.from(".hero_video video", {
        opacity: 0,
        width: "50%",
        height: "50%",
        borderRadius: "4rem",
      ...
      gsapWithCSS.to("html", { "--hero-radius": "2rem", scrollTrigger: heroScroll, ease: "slow" });
      gsapWithCSS.to(".hero_overlay", { opacity: 0.95, scrollTrigger: heroScroll, ease: "slow" });
      gsapWithCSS.to(".hero_scale", { scale: 1, scrollTrigger: heroScroll, ease: "slow" });
      gsapWithCSS.to(".hero_text", { yPercent: -100, scrollTrigger: heroScroll, ease: "slow" });
      gsapWithCSS.from(".hero_second-text", { yPercent: 50, scrollTrigger: heroScroll, ease: "slow" });
      gsapWithCSS.from("[data-x]", {
        scrollTrigger: heroScroll,
        x: (i, el) => el.getAttribute("data-x"),
        ease: "slow"
      });
      gsapWithCSS.from("[data-y]", {
        scrollTrigger: heroScroll,
        y: (i, el) => el.getAttribute("data-y"),
        ease: "slow"
      });
      gsapWithCSS.from("[data-xy]", {
        scrollTrigger: heroScroll,
        x: (i, el) => el.getAttribute("data-xy").split(",")[0],
        y: (i, el) => el.getAttribute("data-xy").split(",")[1],
        ease: "slow"
      });
      let textTimeline = gsapWithCSS.timeline();
      textTimeline.to(".hero_text", { opacity: 0 }).to(".hero_second-text h2", { opacity: 1 }).to(".hero_second-text p", { opacity: 1 }).paused(true);
      ...
      let studyTimeline = gsapWithCSS.timeline({
        scrollTrigger: ".section_study"
      });
      studyTimeline.from(".study_image", { width: 0, duration: 1 }).from(".study_cta", { opacity: 0, y: 20, duration: 1 }).to(".study_image", { width: "100%", duration: 1, ease: "power4.out" }).to(".study_cta", {
        opacity: 1,
        y: 0,
        duration: 1,
        ease: "power4.out",
    ...
    if (boxSections) {
      boxSections.forEach((section) => {
        ...
        let boxTimeline = gsapWithCSS.timeline({ scrollTrigger: section });
        boxTimeline.from(container, { scale: 0.5, borderRadius: "6rem" }).from(background, { width: "0%", height: "50%", borderRadius: "0rem", duration: 2 }).from(content, { y: 100, opacity: 0, duration: 1.5, delay: 1.5 }, "<").to(container, { scale: 1, borderRadius: "2rem", duration: 2 });
      });
    }
    ...
    if (parallaxElements) {
      parallaxElements.forEach((parallaxWrapper) => {
        ...
        if (parallax) {
          ...
          let parallaxTimeline = gsapWithCSS.timeline();
          parallaxTimeline.from(parallax, { y: -heightDiff * 0.5 }).to(parallax, { y: heightDiff * 0.5 }).paused(true);
          ScrollTrigger2.create({
    ...
    let loadOutTimeline = gsapWithCSS.timeline();
    const loadOut = () => {
      loadOutTimeline.to(".main-wrapper", {
        opacity: 0,
        y: 100,
        duration: 1,
        ease: "slow"
